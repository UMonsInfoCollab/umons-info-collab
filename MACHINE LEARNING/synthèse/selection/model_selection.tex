\section{Sélection de modèle}
    ...
    \subsection{Mesures et méthodes}
        ...
        \begin{definition}[\(\AIC\) et \(AIC_C\)]
            ...
            Pour des petites valeurs de \(n\), l'AIC a tendance à sélectionner trop de variables. Pour contrer ça, une version qui corrige le biais de l'AIC à été développé\index{Corrected AIC} (notée \(\AIC_C\)\index{AICC@\(\AIC_C\)}) :
            \[
